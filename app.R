                 ...
                 tabsetPanel(
                   ...
                   tabPanel(HTML("<font color=black>About the app</font>"),
                            HTML("<br/><b>Instruction</b><br/>
                                 ...
                                 In the input tab, you have to write one or more words, and the app will predict the next word.<br/>
                                 <br/><b>Data</b><br/>
                                 The corpora used for the algorithm are collected from publicly available sources of blogs, tweets and news sites, you can find more information 
...
server <- function(input, output) {
  ...
  observe({
    ...
    output$word <- renderPrint({
      if(input$Word == '') {print(HTML(""), row.names=FALSE)
      } else {
        if(Found == 'N') {
...
# call this file app.R and in the console you have to type: runApp("directory of the app.R file")
# runApp("Studies/Capstone Project/App/improvement")
